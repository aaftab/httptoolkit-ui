...
exports.stopDockerTunnel = exports.refreshDockerTunnelPortCache = exports.getDockerTunnelPort = exports.updateDockerTunnelledNetworks = exports.ensureDockerTunnelRunning = exports.prepareDockerTunnel = void 0;
...
function ensureDockerTunnelRunning(proxyPort) {
    ...
    ongoingEnsureTunnelRunningChecks[proxyPort] = containerMutex.runExclusive(async () => {
        ...
        if (!container) {
            ...
            }).then(([builtinBridge]) => { var _a, _b; return (_b = (_a = builtinBridge === null || builtinBridge === void 0 ? void 0 : builtinBridge.IPAM) === null || _a === void 0 ? void 0 : _a.Config) === null || _b === void 0 ? void 0 : _b[0].Gateway; });
            await docker.createContainer({
                ...
                HostConfig: Object.assign(Object.assign({ AutoRemove: true }, (process.platform === 'linux' ? {
                    ExtraHosts: [
                        ...
                        `${docker_commands_1.DOCKER_HOST_HOSTNAME}:${semver.satisfies(engineVersion, '>= 20.10')
                            ? 'host-gateway'
        ...
        if (!_.isObject(portCache[proxyPort]) && (localTunnelPort === null || localTunnelPort === void 0 ? void 0 : localTunnelPort.HostPort) !== String(portCache[proxyPort])) {
            ...
            const refreshTunnelPort = (0, promise_1.delay)(10).then(() => // Leave time for the port to bind
            ...
            refreshTunnelPort.catch(error_tracking_1.reportError);
        }
    }).finally(() => {
...
async function updateDockerTunnelledNetworks(proxyPort, interceptedNetworks) {
    ...
    }).then(([builtinBridge]) => builtinBridge === null || builtinBridge === void 0 ? void 0 : builtinBridge.Id);
    const containerName = getDockerTunnelContainerName(proxyPort);
...
async function refreshDockerTunnelPortCache(proxyPort, { force } = { force: false }) {
    ...
    try {
        ...
        if (!localPort) {
            ...
            await ensureDockerTunnelRunning(proxyPort);
            await (0, promise_1.delay)(10); // Wait for the port to bind after startup
            return refreshDockerTunnelPortCache(proxyPort, { force: true });
        }
...
exports.refreshDockerTunnelPortCache = refreshDockerTunnelPortCache;
